...
const AddProduct = () => {
    ...
    return (
        <div className='p-8 box-border bg-white w-full rounded-sm mt-5 lg:ml-5'>
            ...
            <div className='mb-3'>
                <h4 className='bold-18 pb-2'>Gía:</h4>
            ...
            <div className='mb-3'>
                <h4 className='bold-18 pb-2'>Gía khuyến mãi :</h4>
            ...
            <div className='mb-3'>
                <h4 className='bold-18 pb-2'>Số lượng:</h4>
                <input value={productDetails.quantity} onChange={changeHandler} type="text" name='quantity' placeholder='Type here..' className='bg-primary outline-none max-w-80 w-full py-3 px-4 rounded-md' />
            </div>
