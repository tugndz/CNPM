            ...
            <div className='flex-col flex xl:flex-[1.5] bg-white px-6 py-2 rounded-xl'>
                ...
                <div>
                    ...
                    <div className='flex flex-col sm:flex-row gap-x-10 gap-y-3 my-6'>
                        <div>
                            <h4 className='bold-16'>Chọn màu:</h4>
                        ...
                        <div>
                            <h4 className='bold-16'>Chọn bộ nhớ:</h4>
                            <div className='flex gap-3 my-3'>
                                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md'>64G</div>
                                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md'>128G</div>
                                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md'>256G</div>
                                <div className='ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer rounded-md'>1TB</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p><span className='medium-16 text-tertiary'>Thể loại :</span> Nam | Nữ | Điện thoại</p>
                    <p><span className='medium-16 text-tertiary'>Tags :</span> Điện thoại | Hiện đại</p>
                </div>
            </div>
        </section>
    )
