...
const RelatedProducts = () => {
    return (
        <div>
            <h4 className='border-l-4 pl-2 border-secondary bold-20'>Sản phẩm liên quan</h4>
            {/* container  */}
                        ...
                        <SwiperSlide key={i}>
                            <Link onClick={window.scrollTo(0, 0)} to={`/product/${item.id}`} className='flexCenter gap-x-5 bg-white p-4 rounded-xl'>
                                ...
                                <div className='flex flex-col gap-y-1'>
                                    ...
                                    <p className='line-clamp-1'>Dẫn đầu công nghệ, thỏa mãn đam mê, Gắn kết mọi người, kết nối mọi nhà, Mang công nghệ đến gần bạn hơn</p>
